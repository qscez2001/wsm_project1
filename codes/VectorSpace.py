...
class VectorSpace:
    ...
    def makeVector(self, wordString):
        ...
        for i in range(len(vector)):
            vector[i] = vector[i] / len(wordList) # term frequency normalized by len
        '''
        return vector
    ...
    def tfidf(self, vector):
        for i in range(len(vector)):
            ...
            vector[i] = vector[i] * math.log(len(self.documentVectors) / (1 + denominator))
        # print(vector)
        return vector
    ...
    def search(self,searchList, way, idf=False):
        ...
        if way == 'cos':
            ...
            ratings = [util.euc_distance(queryVector, documentVector) for documentVector in self.documentVectors]
        #ratings.sort(reverse=True)
        return ratings
